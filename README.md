...
- **Avant d'ajouter de la machinerie autour d'une bibliothèque tierce** (bornes d'attente, arbitrage de course, états de repli, files maison), l'agent va lire ce qu'elle offre nativement et ce que fait l'industrie. **Un outil qui résiste indique souvent qu'on lui demande l'inverse de ce pour quoi il est fait.** Motif mesuré : six chargeurs de données, quatre machines à états et huit gardes anti-course, écrits contre un SDK dont trois lignes d'API native faisaient le travail.
